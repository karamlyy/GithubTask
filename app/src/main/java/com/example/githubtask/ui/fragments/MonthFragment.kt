...
class MonthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.getRepository(DateFilter.MONTH)
        viewModel.month.observeForever{
            adapter.setData(it)
        }
        val recyclerView: RecyclerView = view.findViewById(R.id.lastMonthTrendingRepoRecyclerView)
